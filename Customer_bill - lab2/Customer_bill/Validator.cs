...
namespace Customer_bill
{
    public static class Validator
    {
        ...
        //return true if customer type == type 
        //if not send message to the user
        public static bool IsCustomerOfType(Customer cust, char type)
        { bool result = (cust.Customer_type == type);
            if (!result)  MessageBox.Show("Please select the right operation for this customer","Warning");
            return result;
        }
    } // class
} // namespace
